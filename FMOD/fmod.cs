...
public struct Memory
{
    ...
    {
        return FMOD5_Memory_Initialize(
            poolmem,
            poollen,
            useralloc,
            userrealloc,
...
public struct Debug
{
    ...
    )
    {
        ...
        {
            return FMOD5_Debug_Initialize(
                flags,
                mode,
                callback,
                encoder.byteFromStringUTF8(filename)
            );
        }
    }
...
{
    public static RESULT SetAttributes(
        THREAD_TYPE type,
    ...
    #region importfunctions
    [DllImport(VERSION.dll)]
    private static extern RESULT FMOD5_Thread_SetAttributes(
        THREAD_TYPE type,
        THREAD_AFFINITY affinity,
        THREAD_PRIORITY priority,
        THREAD_STACK_SIZE stacksize
    );
    #endregion
}
...
public struct System
{
    ...
    )
    {
        ...
        RESULT result = FMOD5_System_GetDriverInfo(
            this.handle,
            id,
            stringMem,
            namelen,
    ...
    {
        return FMOD5_System_GetDriverInfo(
            this.handle,
            id,
            IntPtr.Zero,
            0,
    ...
    {
        return FMOD5_System_GetSoftwareFormat(
            this.handle,
            out samplerate,
            out speakermode,
            out numrawspeakers
    ...
    {
        return FMOD5_System_SetFileSystem(
            this.handle,
            useropen,
            userclose,
            userread,
    ...
    public RESULT loadPlugin(string filename, out uint handle, uint priority = 0)
    {
        using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_LoadPlugin(
                this.handle,
                encoder.byteFromStringUTF8(filename),
                out handle,
                priority
    ...
    )
    {
        ...
        RESULT result = FMOD5_System_GetPluginInfo(
            this.handle,
            handle,
            out plugintype,
            stringMem,
    ...
    {
        return FMOD5_System_GetPluginInfo(
            this.handle,
            handle,
            out plugintype,
            IntPtr.Zero,
    ...
    {
        return FMOD5_System_GetStreamBufferSize(
            this.handle,
            out filebuffersize,
            out filebuffersizetype
        );
    }
    ...
    {
        return FMOD5_System_Get3DSettings(
            this.handle,
            out dopplerscale,
            out distancefactor,
            out rolloffscale
    ...
    {
        return FMOD5_System_Get3DListenerAttributes(
            this.handle,
            listener,
            out pos,
            out vel,
    ...
    {
        return FMOD5_System_GetDefaultMixMatrix(
            this.handle,
            sourcespeakermode,
            targetspeakermode,
            matrix,
    ...
    {
        return FMOD5_System_GetFileUsage(
            this.handle,
            out sampleBytesRead,
            out streamBytesRead,
            out otherBytesRead
    ...
    public RESULT createSound(string name, MODE mode, ref CREATESOUNDEXINFO exinfo, out Sound sound)
    {
        using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_CreateSound(
                this.handle,
                encoder.byteFromStringUTF8(name),
                mode,
                ref exinfo,
                out sound.handle
            );
    ...
    )
    {
        using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_CreateStream(
                this.handle,
                encoder.byteFromStringUTF8(name),
                mode,
                ref exinfo,
    ...
    public RESULT createChannelGroup(string name, out ChannelGroup channelgroup)
    {
        using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_CreateChannelGroup(
                this.handle,
                encoder.byteFromStringUTF8(name),
    ...
    public RESULT createSoundGroup(string name, out SoundGroup soundgroup)
    {
        using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_CreateSoundGroup(
                this.handle,
                encoder.byteFromStringUTF8(name),
    ...
    {
        return FMOD5_System_AttachChannelGroupToPort(
            this.handle,
            portType,
            portIndex,
            channelgroup.handle,
    ...
    )
    {
        ...
        RESULT result = FMOD5_System_GetRecordDriverInfo(
            this.handle,
            id,
            stringMem,
            namelen,
    ...
    {
        return FMOD5_System_GetRecordDriverInfo(
            this.handle,
            id,
            IntPtr.Zero,
            0,
    ...
    {
        return FMOD5_System_CreateGeometry(
            this.handle,
            maxpolygons,
            maxvertices,
            out geometry.handle
    ...
    {
        return FMOD5_System_GetGeometryOcclusion(
            this.handle,
            ref listener,
            ref source,
            out direct,
    ...
    [DllImport(VERSION.dll)]
    private static extern RESULT FMOD5_System_GetDSPInfoByType(
        IntPtr system,
        DSP_TYPE type,
        out IntPtr description
    );
...
public struct Sound
{
    ...
    {
        return FMOD5_Sound_Set3DConeSettings(
            this.handle,
            insideconeangle,
            outsideconeangle,
            outsidevolume
    ...
    {
        return FMOD5_Sound_Get3DConeSettings(
            this.handle,
            out insideconeangle,
            out outsideconeangle,
            out outsidevolume
        );
    }
    ...
    {
        return FMOD5_Sound_GetOpenState(
            this.handle,
            out openstate,
            out percentbuffered,
            out starving,
    ...
    )
    {
        ...
        RESULT result = FMOD5_Sound_GetSyncPointInfo(
            this.handle,
            point,
            stringMem,
            namelen,
    ...
    {
        return FMOD5_Sound_GetSyncPointInfo(
            this.handle,
            point,
            IntPtr.Zero,
            0,
    ...
    public RESULT addSyncPoint(uint offset, TIMEUNIT offsettype, string name, out IntPtr point)
    {
        using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_Sound_AddSyncPoint(
                this.handle,
                offset,
                offsettype,
                encoder.byteFromStringUTF8(name),
    ...
    {
        return FMOD5_Sound_SetLoopPoints(
            this.handle,
            loopstart,
            loopstarttype,
            loopend,
    ...
    {
        return FMOD5_Sound_GetLoopPoints(
            this.handle,
            out loopstart,
            loopstarttype,
            out loopend,
...
public struct Channel : IChannelControl
{
    ...
    {
        return FMOD5_Channel_SetLoopPoints(
            this.handle,
            loopstart,
            loopstarttype,
            loopend,
    ...
    {
        return FMOD5_Channel_GetLoopPoints(
            this.handle,
            out loopstart,
            loopstarttype,
            out loopend,
    ...
    {
        return FMOD5_Channel_SetMixLevelsOutput(
            this.handle,
            frontleft,
            frontright,
            center,
    ...
    {
        return FMOD5_Channel_SetMixMatrix(
            this.handle,
            matrix,
            outchannels,
            inchannels,
    ...
    {
        return FMOD5_Channel_GetMixMatrix(
            this.handle,
            matrix,
            out outchannels,
            out inchannels,
    ...
    {
        return FMOD5_Channel_GetFadePoints(
            this.handle,
            ref numpoints,
            point_dspclock,
            point_volume
    ...
    {
        return FMOD5_Channel_Set3DConeSettings(
            this.handle,
            insideconeangle,
            outsideconeangle,
            outsidevolume
    ...
    {
        return FMOD5_Channel_Get3DConeSettings(
            this.handle,
            out insideconeangle,
            out outsideconeangle,
            out outsidevolume
    ...
    {
        return FMOD5_Channel_Get3DDistanceFilter(
            this.handle,
            out custom,
            out customLevel,
            out centerFreq
...
public struct ChannelGroup : IChannelControl
{
    ...
    {
        return FMOD5_ChannelGroup_AddGroup(
            this.handle,
            group.handle,
            propagatedspclock,
            IntPtr.Zero
    ...
    {
        return FMOD5_ChannelGroup_SetMixLevelsOutput(
            this.handle,
            frontleft,
            frontright,
            center,
    ...
    {
        return FMOD5_ChannelGroup_SetMixMatrix(
            this.handle,
            matrix,
            outchannels,
            inchannels,
    ...
    {
        return FMOD5_ChannelGroup_GetMixMatrix(
            this.handle,
            matrix,
            out outchannels,
            out inchannels,
    ...
    public RESULT getDelay(out ulong dspclock_start, out ulong dspclock_end)
    {
        return FMOD5_ChannelGroup_GetDelay(
            this.handle,
            out dspclock_start,
            out dspclock_end,
            IntPtr.Zero
    ...
    public RESULT getFadePoints(ref uint numpoints, ulong[] point_dspclock, float[] point_volume)
    {
        return FMOD5_ChannelGroup_GetFadePoints(
            this.handle,
            ref numpoints,
            point_dspclock,
            point_volume
    ...
    public RESULT get3DMinMaxDistance(out float mindistance, out float maxdistance)
    {
        return FMOD5_ChannelGroup_Get3DMinMaxDistance(
            this.handle,
            out mindistance,
            out maxdistance
        );
    ...
    {
        return FMOD5_ChannelGroup_Set3DConeSettings(
            this.handle,
            insideconeangle,
            outsideconeangle,
            outsidevolume
    ...
    {
        return FMOD5_ChannelGroup_Get3DConeSettings(
            this.handle,
            out insideconeangle,
            out outsideconeangle,
            out outsidevolume
    ...
    public RESULT get3DOcclusion(out float directocclusion, out float reverbocclusion)
    {
        return FMOD5_ChannelGroup_Get3DOcclusion(
            this.handle,
            out directocclusion,
            out reverbocclusion
        );
    ...
    public RESULT get3DDistanceFilter(out bool custom, out float customLevel, out float centerFreq)
    {
        return FMOD5_ChannelGroup_Get3DDistanceFilter(
            this.handle,
            out custom,
            out customLevel,
            out centerFreq
...
public struct DSP
{
    ...
    {
        return FMOD5_DSP_AddInput(
            this.handle,
            input.handle,
            IntPtr.Zero,
            DSPCONNECTION_TYPE.STANDARD
        );
    }
    ...
    {
        return FMOD5_DSP_GetOutput(
            this.handle,
            index,
            out output.handle,
            out outputconnection.handle
        );
    }
    ...
    {
        return FMOD5_DSP_SetChannelFormat(
            this.handle,
            channelmask,
            numchannels,
            source_speakermode
    ...
    {
        return FMOD5_DSP_GetChannelFormat(
            this.handle,
            out channelmask,
            out numchannels,
            out source_speakermode
        );
    }
    ...
    {
        return FMOD5_DSP_GetOutputChannelFormat(
            this.handle,
            inmask,
            inchannels,
            inspeakermode,
    ...
    {
        return FMOD5_DSP_SetParameterData(
            this.handle,
            index,
    ...
    public RESULT getParameterInfo(int index, out DSP_PARAMETER_DESC desc)
    {
        ...
        desc = (DSP_PARAMETER_DESC)
            MarshalHelper.PtrToStructure(descPtr, typeof(DSP_PARAMETER_DESC));
        return result;
    }
    ...
    )
    {
        ...
        RESULT result = FMOD5_DSP_GetInfo(
            this.handle,
            nameMem,
            out version,
            out channels,
...
public struct DSPConnection
{
    ...
    {
        return FMOD5_DSPConnection_SetMixMatrix(
            this.handle,
            matrix,
            outchannels,
            inchannels,
    ...
    {
        return FMOD5_DSPConnection_GetMixMatrix(
            this.handle,
            matrix,
            out outchannels,
            out inchannels,
...
public struct Geometry
{
    ...
    {
        return FMOD5_Geometry_AddPolygon(
            this.handle,
            directocclusion,
            reverbocclusion,
            doublesided,
    ...
    {
        return FMOD5_Geometry_SetPolygonAttributes(
            this.handle,
            index,
            directocclusion,
            reverbocclusion,
    ...
    {
        return FMOD5_Geometry_GetPolygonAttributes(
            this.handle,
            index,
            out directocclusion,
            out reverbocclusion,
...
public struct Reverb3D
{
    ...
    {
        return FMOD5_Reverb3D_Get3DAttributes(
            this.handle,
            ref position,
            ref mindistance,
            ref maxdistance
